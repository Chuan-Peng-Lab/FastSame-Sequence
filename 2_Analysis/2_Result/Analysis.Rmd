...
stages <- c(seq(20, 30, by = 10), 36)#In the first stage we collected 20 subjects, and the second stage we collected 10 subjects
...
bfdf1 %>% 
  ...
  geom_line() + 
  scale_x_continuous(limits = c(20, 36), breaks = c(20, 30, 36)) + 
